  ...
  <section id="settings">
    <div class="col1">
      ...
      <form @submit.prevent>
        ...
        <input id="user_first_name" v-model.trim="user_first_name" type="text" :placeholder="userProfile.user_first_name"/>
        <label for="user_last_name">Last Name</label>
        <input id="user_last_name" v-model.trim="user_last_name" type="text" :placeholder="userProfile.user_last_name"/>
